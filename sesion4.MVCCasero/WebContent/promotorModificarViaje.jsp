...
<br> ${idViaje }
		...
		<table align="left">
			...
			<tr>
				...
				<td id="name"><br> <input type="text" name="name"
					size="15" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td id="name"><br> <input type="text" name="email"
					size="15" /></td>
			</tr>
			...
			<tr>
				...
				<td id=name><input type="datetime-local" name="password2"
					size="15" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td id=name><input type="number" min="1" name="password2"
					size="15" /></td>
			</tr>
			<tr>
				<td>Coste:</td>
